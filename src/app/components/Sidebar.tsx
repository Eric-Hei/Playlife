...
export function Sidebar({ collapsed, onToggle, mobileOpen, onMobileToggle }: SidebarProps) {
  const menuItems = [
    ...
    { icon: Globe, label: 'Missions', active: false },
    { icon: Users, label: 'Structures', active: false },
    { icon: Heart, label: 'Impact', active: false },
    { icon: FileText, label: 'Ressources', active: false },
  ];
