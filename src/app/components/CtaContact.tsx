...
export function CtaContact() {
    return (
        <div className="bg-gradient-to-br from-[#e6244d] to-[#ff4d71] rounded-2xl p-10 flex flex-col md:flex-row items-center justify-between gap-8 text-white shadow-xl shadow-[#e6244d]/20 overflow-hidden relative mb-10 mx-4 md:mx-8">
